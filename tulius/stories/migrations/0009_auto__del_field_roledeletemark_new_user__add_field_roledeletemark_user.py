...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('stories_roledeletemark', 'new_user_id', 'user_id')
    ...
    def backwards(self, orm):
        ...
        db.delete_unique(u'stories_storyauthor', ['story_id', 'user_id'])
        # Removing unique constraint on 'StoryAdmin', fields ['story', 'user']
        db.delete_unique(u'stories_storyadmin', ['story_id', 'user_id'])
        db.rename_column('stories_roledeletemark', 'user_id', 'new_user_id')
        db.rename_column('stories_storyadmin', 'user_id', 'new_user_id')

        # Adding unique constraint on 'StoryAdmin', fields ['story', 'new_user']
        db.create_unique(u'stories_storyadmin', ['story_id', 'new_user_id'])
        db.rename_column('stories_storyauthor', 'user_id', 'new_user_id')
        # Adding unique constraint on 'StoryAuthor', fields ['story', 'new_user']
        db.create_unique(u'stories_storyauthor', ['story_id', 'new_user_id'])
        db.rename_column('stories_role', 'user_id', 'new_user_id')
    ...
    models = {
        ...
        u'stories.roledeletemark': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'role_delete_marks'", 'to': u"orm['tulius.User']"})
        },
        u'stories.story': {
        ...
        u'stories.storyadmin': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'admined stories'", 'to': u"orm['tulius.User']"})
        },
        u'stories.storyauthor': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'authored_stories'", 'to': u"orm['tulius.User']"})
        },
        u'stories.variation': {
