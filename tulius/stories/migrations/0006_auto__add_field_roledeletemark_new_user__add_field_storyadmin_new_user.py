...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RoleDeleteMark.new_user'
        db.add_column(u'stories_roledeletemark', 'new_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='role_delete_marks', to=orm['tulius.User']),
                      keep_default=False)

        # Adding field 'StoryAdmin.new_user'
        db.add_column(u'stories_storyadmin', 'new_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='admined stories', to=orm['tulius.User']),
                      keep_default=False)

        # Adding field 'StoryAuthor.new_user'
        db.add_column(u'stories_storyauthor', 'new_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='authored_stories', to=orm['tulius.User']),
                      keep_default=False)

        # Adding field 'Role.new_user'
        db.add_column(u'stories_role', 'new_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='roles', null=True, to=orm['tulius.User']),
                      keep_default=False)
        
    def backwards(self, orm):
        # Deleting field 'RoleDeleteMark.new_user'
        db.delete_column(u'stories_roledeletemark', 'new_user_id')

        # Deleting field 'StoryAdmin.new_user'
        db.delete_column(u'stories_storyadmin', 'new_user_id')

        # Deleting field 'StoryAuthor.new_user'
        db.delete_column(u'stories_storyauthor', 'new_user_id')

        # Deleting field 'Role.new_user'
        db.delete_column(u'stories_role', 'new_user_id')
