...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'stories_character', 'sex',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Role.sex'
        db.add_column(u'stories_role', 'sex',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'stories_character', 'sex')

        # Deleting field 'Role.sex'
        db.delete_column(u'stories_role', 'sex')
