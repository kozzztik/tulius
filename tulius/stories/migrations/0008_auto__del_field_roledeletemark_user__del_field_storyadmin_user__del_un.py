...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RoleDeleteMark.user'
        db.delete_column(u'stories_roledeletemark', 'user_id')

        # Deleting field 'StoryAdmin.user'
        db.delete_column(u'stories_storyadmin', 'user_id')

        # Adding unique constraint on 'StoryAdmin', fields ['story', 'new_user']
        db.create_unique(u'stories_storyadmin', ['story_id', 'new_user_id'])

        # Deleting field 'StoryAuthor.user'
        db.delete_column(u'stories_storyauthor', 'user_id')

        # Adding unique constraint on 'StoryAuthor', fields ['story', 'new_user']
        db.create_unique(u'stories_storyauthor', ['story_id', 'new_user_id'])

        # Deleting field 'Role.user'
        db.delete_column(u'stories_role', 'user_id')


    def backwards(self, orm):
        # Removing unique constraint on 'StoryAuthor', fields ['story', 'new_user']
        db.delete_unique(u'stories_storyauthor', ['story_id', 'new_user_id'])
        # Removing unique constraint on 'StoryAdmin', fields ['story', 'new_user']
        db.delete_unique(u'stories_storyadmin', ['story_id', 'new_user_id'])
        # The following code is provided here to aid in writing a correct migration        # Adding field 'RoleDeleteMark.user'
        db.add_column(u'stories_roledeletemark', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='role_delete_marks', to=orm['auth.User']),
                      keep_default=False)
        # The following code is provided here to aid in writing a correct migration        # Adding field 'StoryAdmin.user'
        db.add_column(u'stories_storyadmin', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='admined stories', to=orm['auth.User']),
                      keep_default=False)    
        # The following code is provided here to aid in writing a correct migration        # Adding field 'StoryAuthor.user'
        db.add_column(u'stories_storyauthor', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='authored_stories', to=orm['auth.User']),
                      keep_default=False)
        # Adding field 'Role.user'
        db.add_column(u'stories_role', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='roles', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)
        if not db.dry_run:
            for model_name in ['Role', 'RoleDeleteMark', 'StoryAdmin', 'StoryAuthor']:
                orm['stories.' + model_name].objects.all().update(user=models.F('new_user'))
    ...
    models = {
        ...
        u'stories.storyadmin': {
            'Meta': {'unique_together': "(('story', 'new_user'),)", 'object_name': 'StoryAdmin'},
        ...
        u'stories.storyauthor': {
            'Meta': {'unique_together': "(('story', 'new_user'),)", 'object_name': 'StoryAuthor'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
