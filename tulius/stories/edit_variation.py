...
from .edit_variation_forms import EditVariationMainForm, \
    RoleForm, RoleTextForm, RoleDeleteForm
...
class EditVariationRoles(
        VarRightsMixin, VarSubpageMixin, SortableDetailViewMixin, DetailView):
...
class AddRole(
        VarRightsMixin, MessageMixin, RoleFormMixin, SubCreateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        kwargs['catalog_page'] = CatalogPage(
            ...
            parent=EditVariationSubpage(
                self.parent_object, url=EDIT_VARIATION_PAGES_ROLES))
...
class RoleRightsMixin(RightsDetailMixin):
    ...
    def get_role_page(self):
        return CatalogPage(
            ...
            parent=EditVariationSubpage(
                self.object.variation, url=EDIT_VARIATION_PAGES_ROLES))
