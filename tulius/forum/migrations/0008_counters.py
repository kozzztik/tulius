...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for thread in orm.Thread.objects.all():
            thread.first_comment_id = thread.first_comment
            thread.last_comment_id = thread.last_comment
            thread.save()
            
    def backwards(self, orm):
        for thread in orm.Thread.objects.all():
            thread.first_comment = thread.first_comment_id
            thread.last_comment = thread.last_comment_id
            thread.save()
