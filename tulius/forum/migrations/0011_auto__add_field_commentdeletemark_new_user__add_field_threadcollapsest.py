...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CommentDeleteMark.new_user'
        db.add_column(u'forum_commentdeletemark', 'new_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='comments_delete_marks', to=orm['tulius.User']),
                      keep_default=False)

        # Adding field 'ThreadCollapseStatus.new_user'
        db.add_column(u'forum_threadcollapsestatus', 'new_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tulius.User']),
                      keep_default=False)

        # Adding field 'CommentLike.new_user'
        db.add_column(u'forum_commentlike', 'new_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='liked_comments', to=orm['tulius.User']),
                      keep_default=False)

        # Adding field 'ThreadReadMark.new_user'
        db.add_column(u'forum_threadreadmark', 'new_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='forum_readed_threads', to=orm['tulius.User']),
                      keep_default=False)

        # Adding field 'VotingVote.new_user'
        db.add_column(u'forum_votingvote', 'new_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='voting_votes', to=orm['tulius.User']),
                      keep_default=False)

        # Adding field 'Comment.new_user'
        db.add_column(u'forum_comment', 'new_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='forum_comments', to=orm['tulius.User']),
                      keep_default=False)

        # Adding field 'Comment.new_editor'
        db.add_column(u'forum_comment', 'new_editor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='forum_comments_edited', null=True, to=orm['tulius.User']),
                      keep_default=False)

        # Adding field 'Voting.new_user'
        db.add_column(u'forum_voting', 'new_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='create_votings', to=orm['tulius.User']),
                      keep_default=False)

        # Adding field 'Thread.new_user'
        db.add_column(u'forum_thread', 'new_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='forum_threads', to=orm['tulius.User']),
                      keep_default=False)

        # Adding field 'ThreadDeleteMark.new_user'
        db.add_column(u'forum_threaddeletemark', 'new_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='thread_delete_marks', to=orm['tulius.User']),
                      keep_default=False)

        # Adding field 'UploadedFile.new_user'
        db.add_column(u'forum_uploadedfile', 'new_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='forum_files', to=orm['tulius.User']),
                      keep_default=False)

        # Adding field 'ThreadAccessRight.new_user'
        db.add_column(u'forum_threadaccessright', 'new_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='forum_theads_rights', to=orm['tulius.User']),
                      keep_default=False)

        # Adding field 'OnlineUser.new_user'
        db.add_column(u'forum_onlineuser', 'new_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='forum_visit', to=orm['tulius.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CommentDeleteMark.new_user'
        db.delete_column(u'forum_commentdeletemark', 'new_user_id')

        # Deleting field 'ThreadCollapseStatus.new_user'
        db.delete_column(u'forum_threadcollapsestatus', 'new_user_id')

        # Deleting field 'CommentLike.new_user'
        db.delete_column(u'forum_commentlike', 'new_user_id')

        # Deleting field 'ThreadReadMark.new_user'
        db.delete_column(u'forum_threadreadmark', 'new_user_id')

        # Deleting field 'VotingVote.new_user'
        db.delete_column(u'forum_votingvote', 'new_user_id')

        # Deleting field 'Comment.new_user'
        db.delete_column(u'forum_comment', 'new_user_id')

        # Deleting field 'Comment.new_editor'
        db.delete_column(u'forum_comment', 'new_editor_id')

        # Deleting field 'Voting.new_user'
        db.delete_column(u'forum_voting', 'new_user_id')

        # Deleting field 'Thread.new_user'
        db.delete_column(u'forum_thread', 'new_user_id')

        # Deleting field 'ThreadDeleteMark.new_user'
        db.delete_column(u'forum_threaddeletemark', 'new_user_id')

        # Deleting field 'UploadedFile.new_user'
        db.delete_column(u'forum_uploadedfile', 'new_user_id')

        # Deleting field 'ThreadAccessRight.new_user'
        db.delete_column(u'forum_threadaccessright', 'new_user_id')

        # Deleting field 'OnlineUser.new_user'
        db.delete_column(u'forum_onlineuser', 'new_user_id')
    ...
    models = {
        ...
        u'forum.comment': {
            ...
            'editor': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'forum_comments_edited'", 'null': 'True', 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'forum_comments'", 'to': u"orm['auth.User']"}),
        ...
        u'forum.commentdeletemark': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'comments_delete_marks'", 'to': u"orm['auth.User']"})
        },
        u'forum.commentlike': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'liked_comments'", 'to': u"orm['auth.User']"})
        },
        u'forum.onlineuser': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'forum_visit'", 'to': u"orm['auth.User']"}),
        ...
        u'forum.threadaccessright': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'forum_theads_rights'", 'to': u"orm['auth.User']"})
        },
        ...
        u'forum.threaddeletemark': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'thread_delete_marks'", 'to': u"orm['auth.User']"})
        },
        u'forum.threadreadmark': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'forum_readed_threads'", 'to': u"orm['auth.User']"})
        },
        u'forum.uploadedfile': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'forum_files'", 'to': u"orm['auth.User']"})
        },
        u'forum.voting': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'create_votings'", 'to': u"orm['auth.User']"}),
        ...
        u'forum.votingvote': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'voting_votes'", 'to': u"orm['auth.User']"})
        },
        u'tulius.user': {
            'Meta': {'object_name': 'User'},
