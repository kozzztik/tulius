...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ThreadCollapseStatus'
        db.create_table('forum_threadcollapsestatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('thread', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.Thread'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('collapse_threads', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('collapse_rooms', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('forum', ['ThreadCollapseStatus'])

        # Adding unique constraint on 'ThreadCollapseStatus', fields ['thread', 'user']
        db.create_unique('forum_threadcollapsestatus', ['thread_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ThreadCollapseStatus', fields ['thread', 'user']
        db.delete_unique('forum_threadcollapsestatus', ['thread_id', 'user_id'])

        # Deleting model 'ThreadCollapseStatus'
        db.delete_table('forum_threadcollapsestatus')
