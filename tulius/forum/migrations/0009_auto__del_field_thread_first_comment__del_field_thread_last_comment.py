...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Thread.first_comment'
        db.delete_column('forum_thread', 'first_comment')

        # Deleting field 'Thread.last_comment'
        db.delete_column('forum_thread', 'last_comment')


    def backwards(self, orm):
        # Adding field 'Thread.first_comment'
        db.add_column('forum_thread', 'first_comment',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Thread.last_comment'
        db.add_column('forum_thread', 'last_comment',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
