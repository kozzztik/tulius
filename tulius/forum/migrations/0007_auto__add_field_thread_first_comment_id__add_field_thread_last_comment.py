...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Thread.first_comment_id'
        db.add_column('forum_thread', 'first_comment_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Thread.last_comment_id'
        db.add_column('forum_thread', 'last_comment_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Thread.first_comment_id'
        db.delete_column('forum_thread', 'first_comment_id')

        # Deleting field 'Thread.last_comment_id'
        db.delete_column('forum_thread', 'last_comment_id')
