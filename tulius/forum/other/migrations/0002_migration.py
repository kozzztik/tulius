...
def migrate_online_users(apps):
    ...
    OnlineUser = apps.get_model('forum_other', 'OnlineUser')
    count = 0
...
def migrate_data(apps, schema_editor):
    ...
    VotingVote = apps.get_model('forum_other', 'VotingVote')
    count = 0
    ...
    CommentLike = apps.get_model('forum_other', 'CommentLike')
    count = 0
    ...
    ThreadReadMark = apps.get_model('forum_other', 'ThreadReadMark')
    count = 0
    threads_count = 0
