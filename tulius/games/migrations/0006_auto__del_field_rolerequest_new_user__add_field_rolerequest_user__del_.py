...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('games_rolerequest', 'new_user_id', 'user_id')
        db.rename_column('games_gameguest', 'new_user_id', 'user_id')
        
        
        db.rename_column('games_gameinvite', 'new_user_id', 'user_id')
        db.rename_column('games_gameinvite', 'new_sender_id', 'sender_id')
    ...
    def backwards(self, orm):
        ...
        db.rename_column('games_gameinvite', 'sender_id', 'new_sender_id')
        db.rename_column('games_gameinvite', 'user_id', 'new_user_id')

        db.rename_column('games_gameguest', 'user_id', 'new_user_id')
        db.rename_column('games_rolerequest', 'user_id', 'new_user_id')
    ...
    models = {
        ...
        u'games.gameinvite': {
            ...
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sended_invites'", 'to': u"orm['tulius.User']"}),
            'status': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'invites'", 'to': u"orm['tulius.User']"})
        },
        u'games.gamewinner': {
        ...
        u'games.rolerequest': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'requested_games'", 'to': u"orm['tulius.User']"})
        },
