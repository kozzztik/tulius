...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RoleRequest.user'
        db.delete_column(u'games_rolerequest', 'user_id')

        # Deleting field 'GameGuest.user'
        db.delete_column(u'games_gameguest', 'user_id')

        # Deleting field 'GameInvite.sender'
        db.delete_column(u'games_gameinvite', 'sender_id')

        # Deleting field 'GameInvite.user'
        db.delete_column(u'games_gameinvite', 'user_id')

        # Deleting field 'GameWinner.user'
        db.delete_column(u'games_gamewinner', 'user_id')

        # Deleting field 'GameAdmin.user'
        db.delete_column(u'games_gameadmin', 'user_id')


    def backwards(self, orm):
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'RoleRequest.user'
        db.add_column(u'games_rolerequest', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='requested_games', to=orm['auth.User']),
                      keep_default=False)
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'GameGuest.user'
        db.add_column(u'games_gameguest', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='guested_games', to=orm['auth.User']),
                      keep_default=False)
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'GameInvite.sender'
        db.add_column(u'games_gameinvite', 'sender',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='sended_invites', to=orm['auth.User']),
                      keep_default=False)
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'GameInvite.user'
        db.add_column(u'games_gameinvite', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='invites', to=orm['auth.User']),
                      keep_default=False)
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'GameWinner.user'
        db.add_column(u'games_gamewinner', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='winned_games', to=orm['auth.User']),
                      keep_default=False)
        # The following code is provided here to aid in writing a correct migration        # Adding field 'GameAdmin.user'
        db.add_column(u'games_gameadmin', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='admined_games', to=orm['auth.User']),
                      keep_default=False)

        if not db.dry_run:
            for model_name in ['GameAdmin', 'GameGuest', 'GameWinner', 'RoleRequest', 'GameInvite']:
                orm['games.' + model_name].objects.all().update(user=models.F('new_user'))
                if model_name == 'GameInvite':
                    orm['games.' + model_name].objects.all().update(sender=models.F('new_sender'))
