...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        player_model = orm['tulius.user']
        from pm.models import PrivateMessage
        for player in player_model.objects.all():
            count = PrivateMessage.objects.filter(receiver=player, is_read=False, removed_by_receiver=False).count()
            player.not_readed_messages = count
            player.save()
