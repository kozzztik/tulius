...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column(u'bugtracker_jirauser', 'user_id')
        db.delete_column(u'bugtracker_bug', 'reporter_id')
        db.delete_column(u'bugtracker_buguploadedfile', 'user_id')
        db.delete_column(u'bugtracker_issuecomment', 'user_id')

        db.rename_column('bugtracker_jirauser', 'new_user_id', 'user_id')
        db.rename_column('bugtracker_bug', 'new_reporter_id', 'reporter_id')
        db.rename_column('bugtracker_buguploadedfile', 'new_user_id', 'user_id')
        db.rename_column('bugtracker_issuecomment', 'new_user_id', 'user_id')


    def backwards(self, orm):
        db.rename_column('bugtracker_jirauser', 'user_id', 'new_user_id')
        db.rename_column('bugtracker_bug', 'reporter_id', 'new_reporter_id')
        db.rename_column('bugtracker_buguploadedfile', 'user_id', 'new_user_id')
        db.rename_column('bugtracker_issuecomment', 'user_id', 'new_user_id')

        db.add_column(u'bugtracker_jirauser', 'user_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, default=None, related_name='jira_data', to=orm['auth.User']),
                      keep_default=False)
        db.add_column(u'bugtracker_bug', 'reporter_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, default=None, related_name='bugs_reported', to=orm['auth.User']),
                      keep_default=False)
        db.add_column(u'bugtracker_buguploadedfile', 'user_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='bug_files', to=orm['auth.User']),
                      keep_default=False)
        db.add_column(u'bugtracker_issuecomment', 'user_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, default=None, related_name='comments_on_issues', to=orm['auth.User']),
                      keep_default=False)
    ...
    models = {
        ...
        u'bugtracker.bug': {
            ...
            'new_reporter': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'bugs_reported'", 'null': 'True', 'to': u"orm['tulius.User']"}),
        ...
        u'bugtracker.buguploadedfile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'new_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bug_files'", 'to': u"orm['tulius.User']"}),
        ...
        u'bugtracker.issuecomment': {
            ...
            'jiraid': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'updated_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'comments_on_issues'", 'null': 'True', 'to': u"orm['tulius.User']"}),
            'new_user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'comments_on_issues'", 'null': 'True', 'to': u"orm['tulius.User']"})
        },
        u'bugtracker.jirauser': {
            ...
            'new_user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'jira_data'", 'null': 'True', 'to': u"orm['tulius.User']"}),
