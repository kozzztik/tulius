...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.animation_speed'
        db.add_column(u'tulius_user', 'animation_speed',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.animation_speed'
        db.delete_column(u'tulius_user', 'animation_speed')
