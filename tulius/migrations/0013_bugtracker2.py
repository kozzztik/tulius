...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for model_name in ['JiraUser', 'Bug', 'BugUploadedFile', 'IssueComment']:
            if model_name == 'Bug':
                orm['bugtracker.' + model_name].objects.all().update(new_reporter=models.F('reporter'))
            else:
                orm['bugtracker.' + model_name].objects.all().update(new_user=models.F('user'))

    def backwards(self, orm):
        for model_name in ['JiraUser', 'Bug', 'BugUploadedFile', 'IssueComment']:
            if model_name == 'Bug':
                orm['bugtracker.' + model_name].objects.all().update(reporter=models.F('new_reporter'))
            else:
                orm['bugtracker.' + model_name].objects.all().update(user=models.F('new_user'))
