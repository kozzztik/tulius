...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column(u'wysibb_uploadedfile', 'user_id')
        db.delete_column(u'wysibb_uploadedimage', 'user_id')

        db.rename_column('wysibb_uploadedfile', 'new_user_id', 'user_id')
        db.rename_column('wysibb_uploadedimage', 'new_user_id', 'user_id')

    def backwards(self, orm):
        db.rename_column('wysibb_uploadedfile', 'user_id', 'new_user_id')
        db.rename_column('wysibb_uploadedimage', 'user_id', 'new_user_id')

        db.add_column(u'wysibb_uploadedfile', 'user_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, default=None, related_name='wysibb_files', to=orm['auth.User']),
                      keep_default=False)
        db.add_column(u'wysibb_uploadedimage', 'user_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, default=None, related_name='wysibb_images', to=orm['auth.User']),
                      keep_default=False)
    ...
    models = {
        ...
        u'wysibb.uploadedfile': {
            ...
            'new_user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'wysibb_files'", 'null': 'True', 'to': u"orm['tulius.User']"}),
        ...
        u'wysibb.uploadedimage': {
            ...
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'mime': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'new_user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'wysibb_images'", 'null': 'True', 'to': u"orm['tulius.User']"}),
