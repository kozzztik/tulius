...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for model_name in ['OldUser']:
            orm['old_site_migrate.' + model_name].objects.all().update(new_user=models.F('user'))

    def backwards(self, orm):
        for model_name in ['OldUser']:
            orm['old_site_migrate.' + model_name].objects.all().update(user=models.F('new_user'))
