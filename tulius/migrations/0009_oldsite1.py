...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column(u'old_site_migrate_olduser', 'new_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='old_version', to=orm['tulius.User']),
                      keep_default=False)


    def backwards(self, orm):
        db.delete_column(u'old_site_migrate_olduser', 'new_user')
