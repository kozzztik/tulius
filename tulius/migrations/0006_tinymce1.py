...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column(u'tinymce_fileupload', 'new_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='tinymce_uploads', to=orm['tulius.User']),
                      keep_default=False)


    def backwards(self, orm):
        db.delete_column(u'tinymce_fileupload', 'user')
