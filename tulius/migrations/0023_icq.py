...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        old_user_model = orm['old_site_migrate.olduser']
        for obj in old_user_model.objects.all():
            if obj.icq:
                icq = obj.icq.lstrip()[:12]
                user = obj.user
                user.icq = icq
                user.save()
    ...
    models = {
        ...
        u'old_site_migrate.olduser': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'old_version'", 'null': 'True', 'to': u"orm['tulius.User']"}),
