...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.vk_profile'
        db.add_column(u'tulius_user', 'vk_profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vk.VK_Profile'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.vk_profile'
        db.delete_column(u'tulius_user', 'vk_profile_id')
