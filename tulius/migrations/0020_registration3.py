...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column(u'registration_registrationprofile', 'user_id')

        db.rename_column('registration_registrationprofile', 'new_user_id', 'user_id')


    def backwards(self, orm):
        db.rename_column('registration_registrationprofile', 'user_id', 'new_user_id')

        db.add_column(u'registration_registrationprofile', 'user_id',
    ...
    models = {
        ...
        u'registration.registrationprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'new_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tulius.User']", 'unique': 'True'}),
    ...
    complete_apps = ['registration', 'tulius']