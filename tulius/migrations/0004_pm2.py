...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for model_name in ['PrivateTalking', 'PrivateMessage']:
            orm['pm.' + model_name].objects.all().update(new_sender=models.F('sender'))
            orm['pm.' + model_name].objects.all().update(new_receiver=models.F('receiver'))

    def backwards(self, orm):
        for model_name in ['PrivateTalking', 'PrivateMessage']:
            orm['pm.' + model_name].objects.all().update(sender=models.F('new_sender'))
            orm['pm.' + model_name].objects.all().update(receiver=models.F('new_receiver'))
