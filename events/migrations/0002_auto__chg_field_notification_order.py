...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Notification.order'
        db.alter_column('events_notification', 'order', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Notification.order'
        raise RuntimeError("Cannot reverse this migration. 'Notification.order' and its values cannot be restored.")
