...
def activate(request, backend,
             template_name='registration/activate.haml',
    ...
    ``registration/activate.haml`` to display an error message; to
    ...
    **Arguments**
    ...
    ``template_name``
        ...
        this will default to ``registration/activate.haml``.
    ...
    **Template:**
    ...
    registration/activate.haml or ``template_name`` keyword argument.
...
def register(request, backend, success_url=None, form_class=None,
             ...
             template_name='registration/registration_form.haml',
             extra_context=None):
    """
    ...
    **Optional arguments**
    ...
    ``template_name``
        ...
        to ``registration/registration_form.haml``.
    ...
    **Template:**
    ...
    registration/registration_form.haml or ``template_name`` keyword
    argument.
